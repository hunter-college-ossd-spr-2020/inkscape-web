    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_admin', models.BooleanField(default=False, help_text='Designates whether the user can log into this admin site.', verbose_name='staff status', db_column='is_staff')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', inkscape.fields.ResizedImageField(format='PNG', upload_to='photos', max_width=190, min_height=0, max_height=190, blank=True, min_width=0, null=True, verbose_name='Photograph (square)')),
