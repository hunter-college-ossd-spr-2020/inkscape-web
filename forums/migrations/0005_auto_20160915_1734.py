    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_id', models.CharField(help_text='A unique identifier for this message', unique=True, max_length=255, db_index=True)),
        ...
        migrations.AddField(
            model_name='forum',
            name='sync',
            field=models.CharField(help_text='When sync source is set, new topics and messages can not be created. Instead, sync messages are collated into topics and replies by helper scripts', max_length=64, null=True, verbose_name='Sync From', blank=True),
        ),
        migrations.AddField(
