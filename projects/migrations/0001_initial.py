    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', inkscape.fields.ResizedImageField(format='PNG', upload_to='project/banner', max_height=120, min_height=90, max_width=920, min_width=600, verbose_name='Banner (120x920)')),
                ('logo', inkscape.fields.ResizedImageField(format='PNG', upload_to='project/logo', max_height=150, min_height=150, max_width=150, min_width=150, verbose_name='Logo (150x150)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', inkscape.fields.ResizedImageField(format='PNG', upload_to='project/update/%Y', max_width=400, min_height=0, max_height=400, blank=True, min_width=0, null=True, verbose_name='Image')),
                ('created', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('edited', models.DateTimeField(auto_now=True)),
