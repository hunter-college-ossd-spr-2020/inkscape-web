    ...
    def default(self, o): # pylint: disable=E0202
        ...
        if isinstance(o, Resource):
            return {
                'name': o.name,
                'user': str(o.user),
                'avatar' : str(o.user.photo_url),
                'desc': o.desc,
                'link': o.link,
                'absolute_url':self.url(o.get_absolute_url),
                'created_human': timetag(o.created),
                'created': o.created,
                'edited': o.edited,
                'verified': o.verified,
                'size': filesizeformat(o.download.size),
                'approved':  o.gallery.is_contest and o.checked_by,
