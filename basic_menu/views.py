...
class ShowMenu(View):
    def __init__(self, request):
        self.lenguage = request.LANGUAGE_CODE
    ...
    #        return render_to_response('menu.html', cached_menu)
        menu = {}
        mymenu = Menu();
        rootel = mymenu.get_root()
        for item in mymenu.get_children(self.lenguage, rootel):
            submenu = {}
            for subitem in mymenu.get_children(self.lenguage, item):
