    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', inkscape.fields.ResizedImageField(format=b'PNG', upload_to=b'release/icons', max_width=32, min_height=0, max_height=32, blank=True, min_width=0, null=True, verbose_name='Icon (32x32)')),
                ('image', inkscape.fields.ResizedImageField(format=b'PNG', upload_to=b'release/icons', max_width=256, min_height=0, max_height=256, blank=True, min_width=0, null=True, verbose_name='Logo (256x256)')),
